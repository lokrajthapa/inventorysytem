...
class InventoryController extends Controller
{
    ...
    {
        if ($request->itemsdetailstoreid) {
            $itemsupdate = Inventorysetting::find($request->itemsdetailstoreid);
            ...
            //    $itemsupdate ->itemStatus =$request->status;      
            $itemsupdate->units = $request->units;
            //    $itemsupdate ->vatable =$request->vatable;      
            //    $itemsupdate ->status =$request->unit_status;      
            //    $itemsupdate ->beIn =$request->beIn;
            $itemsupdate->update();
        ...
        $itemsdetails->sub_groups_id = $request->subgroup_id;
        $itemsdetails->company_id = $request->company_id;
        // $itemsdetails ->itemStatus =$request->status;      
        $itemsdetails->units = $request->units;
        // $itemsdetails ->vatable =$request->vatable;      
        // $itemsdetails ->status =$request->unit_status;      
        // $itemsdetails ->beIn =$request->beIn;      
        $itemsdetails->save();
